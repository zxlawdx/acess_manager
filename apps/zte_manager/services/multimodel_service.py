...
FAMILY["f6201b_candidate"] = {
    ...
    "wifi_radio_advanced": ReadEndpoint("wlanBasic", "wlan_wlanbasicadconf_lua.lua", "OBJ_WLANSETTING_ID"),
...
DISCOVERY_NAMES = {
    ...
    "wifi_radios": "Rádios Wi-Fi", "wifi_radio_advanced": "Rádio avançado (canal/potência)", "lan_ports": "Portas Ethernet",
